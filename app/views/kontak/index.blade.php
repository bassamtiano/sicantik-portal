...
@section('js-script')
	{{ HTML::script('assets/controllers/KontakCtrl.js') }}
@stop

@section('body-article')

	<div class="body-article text" ng-controller="KontakCtrl">
		<div class="article-text-title">
			@{{ portal_kontak_data.judul_informasi }}
		</div>

		<div class="article-text-content" >
			<p ng-bind-html="isi_informasi">
