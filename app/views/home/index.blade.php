...
@section('js-script')
	...
	{{ HTML::script('assets/controllers/HomeCtrl.js') }}

@stop

@section('body-article')

	<div class="body-article" ng-controller="HomeCtrl">

		<div ng-repeat="ahd in admin_home_data">
			<div class="article-item">
				<div class="article-picture">
					<center><img ng-src='assets/uploads/berita/@{{ ahd.gambar_berita }}'></center>
				</div>
				<div class="article-title">
					<p>@{{ ahd.judul_berita }}</p>
				</div>
