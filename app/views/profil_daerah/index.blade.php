...
@section('js-script')
	{{ HTML::script('assets/controllers/ProfildaerahCtrl.js') }}
	{{ HTML::script('assets/js/angular-xml.min.js') }}
@stop

@section('body-article')

	<div class="body-article text" ng-controller="ProfildaerahCtrl">
		<div class="article-text-title">
			@{{ portal_profil_daerah_data.judul_informasi }}
		</div>

		<div class="article-text-content" >
			<p ng-bind-html="isi_informasi"></p>
		</div>
	</div>
