...
@section('js-script')
	{{ HTML::script('assets/controllers/InfoPublikCtrl.js') }}
@stop

@section('body-article')

	<div class="body-article" ng-controller="InfoPublikCtrl">
		...
		<div ng-repeat="pipd in portal_info_publik_data">

			<div class="article-item-list">
				<div class="item-list-pict">
					<img ng-src='assets/uploads/berita/@{{ pipd.gambar_berita }}' />
				</div>
				<div class="item-list-wrapper">
					<div class="list-wrapper-title">
						@{{ pipd.judul_berita }}
					</div>
					<div class="list-wrapper-date">
						@{{ pipd.tanggal_berita }}
					</div>
					<div class="list-wrapper-content">
						@{{ pipd.isi_berita }}
					</div>
					<div class="list-wrapper-menu">
						Baca selengkapnya
					</div>
				</div>
			</div>
