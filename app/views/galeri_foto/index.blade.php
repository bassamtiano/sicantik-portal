...
@section('js-script')
	{{ HTML::script('assets/controllers/GaleriCtrl.js') }}
@stop

@section('body-article')

	<div class="body-article" ng-controller="GaleriCtrl">
		...
		<div class="article-item" ng-repeat="agd in admin_galeri_data | orderBy:predicate:reverse | filter:search">
			<div class="article-picture">
				<img ng-src="assets/uploads/galeri/@{{agd.N_ALAMAT_GALLERY}}"/>
			</div>
			<div class="article-title">
				<p>@{{ agd.N_KETERANGAN_GALLERY }}</p>
			</div>
